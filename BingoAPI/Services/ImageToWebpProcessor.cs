...
namespace BingoAPI.Services
{
    public class ImageToWebpProcessor : IImageToWebpProcessor
    {
        ...
        {
            ImageProcessingResult resultList = new ImageProcessingResult { ProcessedPictures = new List<Image>(), Result = true };
            ...
            foreach (var image in images)
            {
                ...
                {
                 resultList.ProcessedPictures.Add(
                     new Bitmap(imageFactory.Load(image.OpenReadStream())
